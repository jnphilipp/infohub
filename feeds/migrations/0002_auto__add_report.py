...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('feeds', ['Report'])


    def backwards(self, orm):
        # Deleting model 'Report'
        db.delete_table('feeds_report')
    ...
    models = {
        'feeds.feed': {
            ...
            'parser': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['parsers.Parser']", 'null': 'True', 'blank': 'True'}),
