from bundestag.models import Plenarprotokoll, TextFieldSingleLine
from django.contrib import admin
from django.db.models import Count
from django.forms import TextInput
from django.db import models

class PlenarprotokollAdmin(admin.ModelAdmin):
	#def show_link(self, obj):
	#	return '<a href="%s"><i class="icon-eye-open icon-alpha75"></i>View on site</a>' % obj.get_absolute_url()

	def queryset(self, request):
		return Plenarprotokoll.objects.annotate(document_count=Count('document'))
...
admin.site.register(Plenarprotokoll, PlenarprotokollAdmin)